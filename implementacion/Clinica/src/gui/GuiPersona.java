...
public class GuiPersona extends javax.swing.JFrame {
    ...
    private GuiPersona(Persona p) {
        ...
        if (p != null) {
            ...
            jButton1.setText("Modificar Datos Persona");
            this.setTitle("Modificando datos de Persona");
        } else {
            jTextField1.enable();
            jButton1.setText("Registrar Datos Persona");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (this.p == null) {
            ...
            this.p.setNombres(jTextField2.getText().toUpperCase());
            this.p.setApellidos(jTextField3.getText().toUpperCase());
            this.p.setDireccion(jTextField4.getText().toUpperCase());
